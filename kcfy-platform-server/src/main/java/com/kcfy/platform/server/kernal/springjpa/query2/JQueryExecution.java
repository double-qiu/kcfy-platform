...
import com.kcfy.platform.server.kernal.springjpa.query.QueryExecution;
...
//			return query.getResultList();
	...
	static class PagedExecution extends JQueryExecution {
		...
		protected JPage doExecute() {
			...
			QueryExecution.setQueryParameters(countQuery, _query.getParams());
			long count=0;
			...
			Query query=_query.getQuery();
			QueryExecution.setQueryParameters(query, _query.getParams());
...
//			List list= query.getResultList();
			...
			simplePageImpl.setStart(_query.getPageable().getPageNumber()*page.getPageable().getPageSize());
